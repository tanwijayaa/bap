...
class matakuliahController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('matakuliah')->with('flash_message', 'matakuliah added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('matakuliah')->with('flash_message', 'matakuliah updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('matakuliah')->with('flash_message', 'matakuliah deleted!');
    }
}
